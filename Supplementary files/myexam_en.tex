...
%% packages
\usepackage{a4wide,color,verbatim,Sweave,url,xargs,amsmath}
\usepackage{hyperref}
...
%% headings
\markboth{\textnormal{\bf \large R Exercises: \myID}}%
{\textnormal{\bf \large R Exercises: \myID}}
...
\thispagestyle{empty}
{\sf
\textbf{\LARGE{R Exercises (\myDate) \hfill Exam ID \myID}}

%\textbf{\large{R exercises for book \myDate \hfill Exam ID \myID}}
\vspace{0.5cm} 

The exercises distributed here are part of the content for the book \textbf{Processamento e Modelagem de Dados Financeiros com o R} by Marcelo S. Perlin, available at \href{https://www.amazon.com/Processamento-Modelagem-Dados-Financeiros-Portuguese/dp/8592243513/ref=sr_1_1?ie=UTF8&qid=1486642147&sr=8-1&keywords=Marcelo+perlin}{Amazon}.

\vspace{0.5cm} 

\begin{center}
\includegraphics[width=0.5\linewidth]{CAPADigital_DadosFinanceirosR}
\end{center}

\vspace{0.5cm} 

The content here is distributed under the \href{https://en.wikipedia.org/wiki/MIT_License}{MIT license}.
